...
var trs=
{
    ...
    blockedRequest:'Tag request blocked, likely by AdBlocker (not recorded, copied to clipboard)',
    ...
    title:{
        ...
        copy:"Copy displayed tag summaries and raw queries as TSV (with header)",
        copytsv:"Copy displayed tag queries as TSV (parameters in header, values in columns)",

...
var trs=
{
    ...
    blockedRequest:'Tag request blocked, probably by some AdBlocker: not recorded, but copied in the clipboard',
    ...
    title:{
        ...
        copy:"Copy all displayed tag summaries and raw queries to TSV format with header",
        copytsv:"Copy all displayed tag queries sliced into TSV format with parameters in header and values in columns",
        ...
        rowchart:"CTA Chart",
        raise:"Activate focus on tag detection",
        raiseon:"Stop focus on tag detection"
    }, 
    clabel:{
        page:"Pages",
        cta:"CTA",
